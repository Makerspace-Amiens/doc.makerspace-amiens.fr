...
hardwares:
  - label: SnapMaker 2.0 A350T
    link: /docs/references/machines/snapmaker/
---
...
{% include risk-item.html level="modere" icon="fas fa-burst" title="Projections" content="Copeaux et poussières sont projetés pendant le fraisage." %}

{% include risk-item.html level="modere" icon="fas fa-volume-high" title="Bruit (risque cumulatif)" content="Une exposition prolongée et répétée au bruit peut endommager l'audition de manière progressive, sans douleur ni gêne immédiate au moment de l'exposition. Protection auditive recommandée pour un usage prolongé." %}

## EPI et équipements requis

<div class="epi-list">
{% include epi-item.html icon="fas fa-glasses" label="Lunettes de protection" %}
{% include epi-item.html icon="fas fa-ear-listen" label="Protection auditive" %}
</div>

Les lunettes de protection sont obligatoires. La protection auditive est recommandée pour un usage prolongé.
...
{% include consigne-item.html type="dont" content="Ne jamais intervenir manuellement à proximité de l'outil en rotation." %}
{% include consigne-item.html type="do" content="Rester attentif aux projections, se tenir à distance de sécurité pendant le fraisage." %}
</div>
